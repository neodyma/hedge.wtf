...
export function getRepayInstructionDataSerializer(): Serializer<
  RepayInstructionDataArgs,
  RepayInstructionData
> {
  return mapSerializer<RepayInstructionDataArgs, any, RepayInstructionData>(
    ...
    (value) => ({
      ...value,
      discriminator: new Uint8Array([234, 103, 67, 82, 208, 234, 219, 166]),
    })
  ) as Serializer<RepayInstructionDataArgs, RepayInstructionData>;
}
